...
<html>
    ...
    <div class="login">
        ...
        <div class="login-form">
            <form name="form1" method="post" action="<?php echo base_url() ?>Welcome/index0">  
                <h3>User: admin</h3>
                <input name="user" type="text" placeholder="User"/><br>
                <h3>Password: 58364470</h3>
                <input name="password" type="password" placeholder="Password"/>
                <br>
                <center><input class="button" type="submit" value="Login"/></center>
                <br>
            </form>
            <a class="sign-up" href="../Welcome/Register"><center>Register</center></a>
        </div>
    </div>
</form>
