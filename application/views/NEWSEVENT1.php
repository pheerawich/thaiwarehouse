            ...
            <tbody>
                <?php foreach ($o AS $r): ?>
                    <tr align="center">
                        ...
                        <td><div>
                                <div class="col">
                                    <a href="<?= base_url("Welcome/update1/{$r->id}") ?>" class="btn btn-warning btn-block btn-sm">
                                        แก้ไข
                                    </a>
                                </div> 
                                <div class="col">
                                    <a onclick="return confirm('คุนต้องการจะลบข้อมูลนี้หรือไม่')" href="<?= base_url("Welcome/delete/{$r->id}") ?>" class="btn btn-warning btn-block btn-sm">
                                        ลบ
                                    </a>
                                </div>
                            </div></td>
