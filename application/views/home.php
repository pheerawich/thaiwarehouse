...
<html>
        ...
        <div class="tm-header">
            <div class="container-fluid">
                <div class="tm-header-inner">
                    <a href="../index.php/Welcome" class="navbar-brand tm-site-name ">Thaiwarehouse</a>
                        ...
                        <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                            <ul class="nav navbar-nav">
                                <li class="nav-item active">
                                    <a href="../index.php/Welcome" class="nav-link">Home</a>
                                </li>
                                <li class="nav-item">
                                    <a href="../index.php/Welcome/About" class="nav-link">About</a>
                                </li>
                                <li class="nav-item">
                                    <a href="../index.php/Welcome/NEWSEVENT" class="nav-link">NEWS</a>
                                </li>
                                <li class="nav-item">
                                    <a href="../index.php/Welcome/ContactUS" class="nav-link">Contact US</a>
                                </li>
                                <li class="nav-item">
                                    <a href="../index.php/Welcome/Register" class="nav-link">Register</a>
                                </li>
                                <li class="nav-item">
                                    <a href="../index.php/Welcome/Login" class="nav-link">Login</a>
                                </li>
                            </ul>                        
                        </div>
    ...
    <center>
        <tr>
            <td align="left">
                <form action="<?= base_url('Welcome/search') ?>" method="post" name="frmSearch">
